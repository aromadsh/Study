CREATE DATABASE  IF NOT EXISTS `w3schools` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `w3schools`;
-- MySQL dump 10.13  Distrib 8.0.21, for macos10.15 (x86_64)
--
-- Host: 220.90.200.176    Database: w3schools
-- ------------------------------------------------------
...
CREATE TABLE `customers` (
  ...
  KEY `idx_customers_CustomerID` (`CustomerID`)
...
-- Dump completed on 2020-12-29 20:31:51
